...
public class TimeLineAdapter extends RecyclerView.Adapter<TimeLineAdapter.CustomViewHolder> {
    private ArrayList<TimeLineItem> datas;
    private Context context;

    public TimeLineAdapter(ArrayList<TimeLineItem> datas , Context context) {
        this.datas = datas;
